<template>
  <section style="font-size: 38px;">
    ...
    <p style="margin-top: 60px; margin-left: 24px;">过量饮酒有害健康，孕妇儿童不宜饮酒</p>
  ...
  created() {
    if (this.$route.params.id === '1') {
      this.infos = [
        ...
        {
          title: '产品执行标准 : ',
          text: 'GB/T26760-2011（优级）'
        },
        {
          title: '生产许可证号 : ',
          text: 'SC1155 2038 200372'
        },
        {
          title: '生产日期 : ',
          text: '见包装箱'
      ...
      this.music = '/music/aipincaihuiying.mp3'
      this.images = [
        '/images/image01.jpg',
        '/images/image02.jpg',
        '/images/image03.jpg',
      ...
      this.music = '/music/dabeizhou.mp3'
      this.images = [
        '/images/image01.jpg',
        '/images/image02.jpg',
        '/images/image03.jpg',
